...
public class GuiShaderOptions extends GuiScreenOF
{
    ...
    public void initGui() {
        ...
        final int j2 = 120;
        final int k2 = 20;
        int l2 = Shaders.getShaderPackColumns(this.screenName, 2);
        final ShaderOption[] ashaderoption = Shaders.getShaderPackOptions(this.screenName);
        if (ashaderoption != null) {
            final int i3 = MathHelper.ceil(ashaderoption.length / 9.0);
            if (l2 < i3) {
                l2 = i3;
            }
            for (int j3 = 0; j3 < ashaderoption.length; ++j3) {
                final ShaderOption shaderoption = ashaderoption[j3];
                if (shaderoption != null && shaderoption.isVisible()) {
                    final int k3 = j3 % l2;
                    final int l3 = j3 / l2;
                    final int i4 = Math.min(this.width / l2, 200);
                    j = (this.width - i4 * l2) / 2;
                    final int j4 = k3 * i4 + 5 + j;
                    final int k4 = k + l3 * l;
                    final int l4 = i4 - 10;
                    final String s = getButtonText(shaderoption, l4);
                    GuiButtonShaderOption guibuttonshaderoption;
                    if (Shaders.isShaderPackOptionSlider(shaderoption.getName())) {
                        guibuttonshaderoption = new GuiSliderShaderOption(i + j3, j4, k4, l4, k2, shaderoption, s);
                    }
                    else {
                        guibuttonshaderoption = new GuiButtonShaderOption(i + j3, j4, k4, l4, k2, shaderoption, s);
                    }
