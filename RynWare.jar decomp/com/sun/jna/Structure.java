        ...
        if (!showContents) {
            ...
            while (i.hasNext()) {
                ...
                if (value instanceof Long) {
                    contents += String.format("0x%08X", value);
                }
                else if (value instanceof Integer) {
                    contents += String.format("0x%04X", value);
                }
                else if (value instanceof Short) {
                    contents += String.format("0x%02X", value);
                }
                else if (value instanceof Byte) {
                    contents += String.format("0x%01X", value);
                }
                else {
    ...
    static class FFIType extends Structure
    {
        ...
        private FFIType(final Structure ref) {
            ...
            if (ref instanceof Union) {
                final StructField sf = ref.typeInfoField();
