        ...
        ((AbstractProtocol<ClientboundPackets1_19, C2, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_19.JOIN_GAME, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(wrapper -> {
                    ...
                    final ListTag dimensions = wrapper.get(Type.NBT, 0).get("minecraft:dimension_type").get("value");
                    final HashMap<String, CompoundTag> dimensionsMap = new HashMap<String, CompoundTag>(dimensions.size());
                    boolean found = false;
                    dimensions.iterator();
