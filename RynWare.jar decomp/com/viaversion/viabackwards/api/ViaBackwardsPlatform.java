...
{
    public static final String MINIMUM_VV_VERSION = "4.3.0";
    public static final String IMPL_VERSION = "git-ViaBackwards-4.3.1-SNAPSHOT:f08223d";
    ...
    default void init(final File dataFolder) {
        ...
        Via.getManager().getSubPlatforms().add("git-ViaBackwards-4.3.1-SNAPSHOT:f08223d");
    ...
    default boolean isOutdated() {
        ...
        if (vvVersion != null && new Version(vvVersion).compareTo(new Version("4.3.0--")) < 0) {
            this.getLogger().severe("================================");
            this.getLogger().severe("YOUR VIAVERSION IS OUTDATED");
            this.getLogger().severe("PLEASE USE VIAVERSION 4.3.0 OR NEWER");
