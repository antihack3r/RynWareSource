                ...
                this.handler(packetWrapper -> {
                    ...
                    if (mode != 3) {
                        ...
                        if (gamemode == 3 || tracker.getGamemode() == 3) {
                            ...
                            Item[] equipment;
                            if (gamemode == 3) {
                                final GameProfileStorage.GameProfile profile = packetWrapper.user().get(GameProfileStorage.class).get(uuid);
                            ...
                            for (int i = 1; i < 5; ++i) {
                                final PacketWrapper setSlot = PacketWrapper.create(47, null, packetWrapper.user());
