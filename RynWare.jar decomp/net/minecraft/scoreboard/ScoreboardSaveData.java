...
public class ScoreboardSaveData extends WorldSavedData
{
    ...
    protected void readObjectives(final NBTTagList nbt) {
        for (int i = 0; i < nbt.tagCount(); ++i) {
            ...
            if (iscorecriteria != null) {
                ...
                final ScoreObjective scoreobjective = this.theScoreboard.addScoreObjective(s, iscorecriteria);
    ...
    protected void readScores(final NBTTagList nbt) {
        for (int i = 0; i < nbt.tagCount(); ++i) {
            ...
            final Score score = this.theScoreboard.getOrCreateScore(s, scoreobjective);
