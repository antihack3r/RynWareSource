...
public class EntityDamageSource extends DamageSource
{
    ...
    public ITextComponent getDeathMessage(final EntityLivingBase entityLivingBaseIn) {
        final ItemStack itemstack = (this.damageSourceEntity instanceof EntityLivingBase) ? ((EntityLivingBase)this.damageSourceEntity).getHeldItemMainhand() : ItemStack.field_190927_a;
