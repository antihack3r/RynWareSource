...
public class MathHelper
{
    ...
    public static float lerp(final double a, final double b, final double t) {
        return (float)(a + (b - a) * t);
    }
    
    public static boolean isMouseHoveringOnRect(final double x, final double y, final double width, final double height, final int mouseX, final int mouseY) {
        return mouseX >= x && mouseY >= y && mouseX <= x + width && mouseY <= y + height;
    }
    
    public static float Rotate(final float from, final float to, final float minstep, final float maxstep) {
    ...
    public static double easeInOutQuad(final double x, final int step) {
    ...
    public static float EaseOutBack(final float start, float end, float value) {
        final float s = 1.20158f;
        end -= start;
        --value;
