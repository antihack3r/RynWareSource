    ...
    public ItemStack slotClick(final int slotId, final int dragType, final ClickType clickTypeIn, final EntityPlayer player) {
        ...
        if (clickTypeIn == ClickType.QUICK_CRAFT) {
            ...
            if (slotId == -999) {
                ...
                for (ItemStack itemstack6 = this.transferStackInSlot(player, slotId); !itemstack6.func_190926_b() && ItemStack.areItemsEqual(slot9.getStack(), itemstack6); itemstack6 = this.transferStackInSlot(player, slotId)) {
