...
public class NetworkManager extends SimpleChannelInboundHandler<Packet<?>>
{
    ...
    protected void channelRead0(final ChannelHandlerContext p_channelRead0_1_, final Packet<?> packetIn) throws Exception {
        final EventReceivePacket event = new EventReceivePacket(packetIn);
    ...
    @SafeVarargs
    public final void sendPacket(final Packet<?> packetIn, final GenericFutureListener<? extends Future<? super Void>> listener, final GenericFutureListener<? extends Future<? super Void>>... listeners) {
        if (this.isChannelOpen()) {
            this.flushOutboundQueue();
