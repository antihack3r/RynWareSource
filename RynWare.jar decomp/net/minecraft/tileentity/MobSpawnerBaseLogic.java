        ...
        if (!this.isActivated()) {
            ...
            if (this.getSpawnerWorld().isRemote) {
                ...
                for (int i = 0; i < this.spawnCount; ++i) {
                    ...
                    final int k = world.getEntitiesWithinAABB(entity.getClass(), new AxisAlignedBB(blockpos.getX(), blockpos.getY(), blockpos.getZ(), blockpos.getX() + 1, blockpos.getY() + 1, blockpos.getZ() + 1).expandXyz(this.spawnRange)).size();
