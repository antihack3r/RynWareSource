...
public class TileEntityBeacon extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    private void addEffectsToPlayers() {
        if (this.isComplete && this.levels > 0 && !this.world.isRemote && this.primaryEffect != null) {
            ...
            final AxisAlignedBB axisalignedbb = new AxisAlignedBB(k, l, i2, k + 1, l + 1, i2 + 1).expandXyz(d0).addCoord(0.0, this.world.getHeight(), 0.0);
    ...
    private void updateSegmentColors() {
        ...
        if (!this.world.isRemote && l < this.levels) {
            for (final EntityPlayerMP entityplayermp : this.world.getEntitiesWithinAABB((Class<? extends EntityPlayerMP>)EntityPlayerMP.class, new AxisAlignedBB(i, j, k, i, j - 4, k).expand(10.0, 5.0, 10.0))) {
