...
public class BlockCommandBlock extends BlockContainer
{
    ...
    private void func_193387_a(final IBlockState p_193387_1_, final World p_193387_2_, final BlockPos p_193387_3_, final CommandBlockBaseLogic p_193387_4_, final boolean p_193387_5_) {
        if (p_193387_5_) {
        ...
        func_193386_c(p_193387_2_, p_193387_3_, p_193387_1_.getValue((IProperty<EnumFacing>)BlockCommandBlock.FACING));
    }
    ...
    public IBlockState getStateFromMeta(final int meta) {
        return this.getDefaultState().withProperty((IProperty<Comparable>)BlockCommandBlock.FACING, EnumFacing.getFront(meta & 0x7)).withProperty((IProperty<Comparable>)BlockCommandBlock.CONDITIONAL, (meta & 0x8) != 0x0);
    }
    ...
    public IBlockState onBlockPlaced(final World worldIn, final BlockPos pos, final EnumFacing facing, final float hitX, final float hitY, final float hitZ, final int meta, final EntityLivingBase placer) {
        return this.getDefaultState().withProperty((IProperty<Comparable>)BlockCommandBlock.FACING, EnumFacing.func_190914_a(pos, placer)).withProperty((IProperty<Comparable>)BlockCommandBlock.CONDITIONAL, false);
    }
    
    private static void func_193386_c(final World p_193386_0_, final BlockPos p_193386_1_, EnumFacing p_193386_2_) {
