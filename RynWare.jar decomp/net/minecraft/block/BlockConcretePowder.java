...
public class BlockConcretePowder extends BlockFalling
{
    ...
    public void onEndFalling(final World worldIn, final BlockPos pos, final IBlockState p_176502_3_, final IBlockState p_176502_4_) {
        if (p_176502_4_.getMaterial().isLiquid()) {
            worldIn.setBlockState(pos, Blocks.field_192443_dR.getDefaultState().withProperty(BlockColored.COLOR, (Comparable)p_176502_3_.getValue((IProperty<V>)BlockConcretePowder.field_192426_a)), 3);
        }
    }
    ...
    protected boolean func_192425_e(final World p_192425_1_, final BlockPos p_192425_2_, final IBlockState p_192425_3_) {
        ...
        if (flag) {
            p_192425_1_.setBlockState(p_192425_2_, Blocks.field_192443_dR.getDefaultState().withProperty(BlockColored.COLOR, (Comparable)p_192425_3_.getValue((IProperty<V>)BlockConcretePowder.field_192426_a)), 3);
        }
        return flag;
    }
