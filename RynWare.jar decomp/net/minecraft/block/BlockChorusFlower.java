...
public class BlockChorusFlower extends Block
{
    ...
    private void placeGrownFlower(final World p_185602_1_, final BlockPos p_185602_2_, final int p_185602_3_) {
        p_185602_1_.setBlockState(p_185602_2_, this.getDefaultState().withProperty((IProperty<Comparable>)BlockChorusFlower.AGE, p_185602_3_), 2);
        p_185602_1_.playEvent(1033, p_185602_2_, 0);
    }
    
    private void placeDeadFlower(final World p_185605_1_, final BlockPos p_185605_2_) {
        p_185605_1_.setBlockState(p_185605_2_, this.getDefaultState().withProperty((IProperty<Comparable>)BlockChorusFlower.AGE, 5), 2);
        p_185605_1_.playEvent(1034, p_185605_2_, 0);
    }
    
    private static boolean areAllNeighborsEmpty(final World p_185604_0_, final BlockPos p_185604_1_, final EnumFacing p_185604_2_) {
