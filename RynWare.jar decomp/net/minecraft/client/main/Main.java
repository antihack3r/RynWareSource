...
public class Main
{
    public static void main(final String[] p_main_0_) {
        ...
        final OptionSpec<String> optionspec10 = (OptionSpec<String>)optionparser.accepts("username").withRequiredArg().defaultsTo((Object)(RandomStringUtils.randomAlphabetic(5).toLowerCase() + RandomStringUtils.randomNumeric(2)), (Object[])new String[0]);
        ...
        final List<String> list = optionset.valuesOf((OptionSpec)optionspec21);
        if (!list.isEmpty()) {
