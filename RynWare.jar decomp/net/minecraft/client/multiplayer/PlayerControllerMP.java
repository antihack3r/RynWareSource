...
import org.rynware.client.event.events.impl.player.EventBlockInteract;
...
public class PlayerControllerMP
{
    ...
    public boolean onPlayerDamageBlock(final BlockPos posBlock, final EnumFacing directionFacing) {
        ...
        final EventBlockInteract eventBlockInteract = new EventBlockInteract(posBlock, directionFacing);
    ...
    public float getBlockReachDistance() {
        return this.currentGameType.isCreative() ? 5.0f : (Main.instance.featureManager.getFeature(ClickTp.class).isEnabled() ? 60.0f : 4.5f);
    }
    ...
    public void attackEntity(final EntityPlayer playerIn, final Entity targetEntity) {
        final EventAttackSilent attackEvent = new EventAttackSilent(targetEntity);
        ...
        final EventPostAttackSilent postAttackSilent = new EventPostAttackSilent(targetEntity);
