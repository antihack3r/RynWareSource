...
import org.rynware.client.event.events.impl.player.EventPostMotion;
import org.rynware.client.event.events.impl.player.EventPreMotion;
import org.rynware.client.event.events.impl.player.EventPlayerState;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate() {
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                if (!Main.instance.featureManager.getFeature(FreeCam.class).isEnabled()) {
    ...
    private void onUpdateWalkingPlayer() {
        ...
        final EventPlayerState eventPreRotation = new EventPlayerState(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
        EventManager.call(eventPreRotation);
        final EventPreMotion eventPre = new EventPreMotion(this.rotationYaw, this.rotationPitch, this.posX, this.posY, this.posZ, this.onGround);
        EventManager.call(eventPre);
        final EventPostMotion eventPost = new EventPostMotion(this.rotationYaw, this.rotationPitch);
        ...
        final EventPlayerState eventPostRotation = new EventPlayerState();
    ...
    protected boolean pushOutOfBlocks(final double x, final double y, final double z) {
        if ((Main.instance.featureManager.getFeature(NoPush.class).isEnabled() && NoPush.blocks.getBoolValue()) || Main.instance.featureManager.getFeature(FreeCam.class).isEnabled() || Main.instance.featureManager.getFeature(NoClip.class).isEnabled()) {
            return false;
        }
        if (!this.noClip) {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isHandActive() && !this.isRiding()) {
            ...
            movementInput.moveStrafe *= (Main.instance.featureManager.getFeature(NoSlowDown.class).isEnabled() ? (NoSlowDown.percentage.getNumberValue() / 100.0f) : 0.2f);
            final MovementInput movementInput2 = this.movementInput;
            movementInput2.moveForward *= (Main.instance.featureManager.getFeature(NoSlowDown.class).isEnabled() ? (NoSlowDown.percentage.getNumberValue() / 100.0f) : 0.2f);
    ...
    public void moveEntity(final MoverType x, final double p_70091_2_, final double p_70091_4_, final double p_70091_6_) {
        ...
        final EventMove eventMove = new EventMove(p_70091_2_, p_70091_4_, p_70091_6_);
