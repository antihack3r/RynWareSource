...
public class GuiWinGame extends GuiScreen
{
            ...
            try {
                ...
                if (this.field_193980_h) {
                    ...
                    while ((s2 = bufferedreader.readLine()) != null) {
                        String s3;
                        String s4;
                        for (s2 = s2.replaceAll("PLAYERNAME", this.mc.getSession().getUsername()); s2.contains(s); s2 = s3 + TextFormatting.WHITE + TextFormatting.OBFUSCATED + "XXXXXXXX".substring(0, random.nextInt(4) + 3) + s4) {
    ...
    private void drawWinGameScreen(final int p_146575_1_, final int p_146575_2_, final float p_146575_3_) {
        ...
        f4 *= f4;
        f4 = f4 * 96.0f / 255.0f;
        bufferbuilder.pos(0.0, this.height, GuiWinGame.zLevel).tex(0.0, f * 0.015625f).color(f4, f4, f4, 1.0f).endVertex();
        bufferbuilder.pos(i, this.height, GuiWinGame.zLevel).tex(i * 0.015625f, f * 0.015625f).color(f4, f4, f4, 1.0f).endVertex();
