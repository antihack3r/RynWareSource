...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    public class CategoryEntry implements IGuiListEntry
    {
        ...
        public void func_192634_a(final int p_192634_1_, final int p_192634_2_, final int p_192634_3_, final int p_192634_4_, final int p_192634_5_, final int p_192634_6_, final int p_192634_7_, final boolean p_192634_8_, final float p_192634_9_) {
            GuiKeyBindingList.this.mc.fontRendererObj.drawString(this.labelText, (float)(GuiKeyBindingList.this.mc.currentScreen.width / 2 - this.labelWidth / 2), (float)(p_192634_3_ + p_192634_5_ - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT - 1), 16777215);
        }
    ...
    public class KeyEntry implements IGuiListEntry
    {
        ...
        public void func_192634_a(final int p_192634_1_, final int p_192634_2_, final int p_192634_3_, final int p_192634_4_, final int p_192634_5_, final int p_192634_6_, final int p_192634_7_, final boolean p_192634_8_, final float p_192634_9_) {
            ...
            GuiKeyBindingList.this.mc.fontRendererObj.drawString(this.keyDesc, (float)(p_192634_2_ + 90 - GuiKeyBindingList.this.maxListLabelWidth), (float)(p_192634_3_ + p_192634_5_ / 2 - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT / 2), 16777215);
