...
import org.rynware.client.event.events.impl.player.EventReceiveMessage;
...
public class GuiNewChat extends Gui
{
                    ...
                    if (chatline != null) {
                        ...
                        if (j2 < 200 || flag) {
                            ...
                            if (l2 > 3) {
                                final int i3 = 0;
                                final int j3 = -i2 * 9;
                                Gui.drawRect(-2.0, j3 - 9, 0 + k + 4, j3, l2 / 2 << 24);
                                final String s = chatline.getChatComponent().getFormattedText();
                                GlStateManager.enableBlend();
                                this.mc.fontRendererObj.drawStringWithShadow(s, 0.0, (float)(j3 - 8), 16777215 + (l2 << 24));
    ...
    public void printChatMessage(final ITextComponent chatComponent) {
        ...
        final EventReceiveMessage event = new EventReceiveMessage(chatComponent.getUnformattedText());
