...
public class GuiButtonRecipeTab extends GuiButtonToggle
{
    ...
    public void func_193918_a(final Minecraft p_193918_1_) {
        final RecipeBook recipebook = p_193918_1_.player.func_192035_E();
        for (final RecipeList recipelist : RecipeBookClient.field_194086_e.get(this.field_193921_u)) {
            for (final IRecipe irecipe : recipelist.func_194208_a(recipebook.func_192815_c())) {
    ...
    public void func_191745_a(final Minecraft p_191745_1_, final int p_191745_2_, final int p_191745_3_, final float p_191745_4_) {
        if (this.visible) {
            if (this.field_193922_v > 0.0f) {
                final float f = 1.0f + 0.1f * (float)Math.sin(this.field_193922_v / 15.0f * 3.1415927f);
    ...
    private void func_193920_a(final RenderItem p_193920_1_) {
        final ItemStack itemstack = this.field_193921_u.getIconItemStack();
    ...
    public boolean func_193919_e() {
        final List<RecipeList> list = RecipeBookClient.field_194086_e.get(this.field_193921_u);
        this.visible = false;
