...
public class GuiScreenBook extends GuiScreen
{
    ...
    private void pageInsertIntoCurrent(final String p_146459_1_) {
        ...
        final int i = this.fontRendererObj.splitStringWidth(s2 + "" + TextFormatting.BLACK + "_", 118);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            this.fontRendererObj.drawString(s2, (float)(i + 36 + (116 - k) / 2), 34.0f, 0);
            final int l = this.fontRendererObj.getStringWidth(s);
            this.fontRendererObj.drawString(s, (float)(i + 36 + (116 - l) / 2), 50.0f, 0);
            final String s3 = I18n.format("book.byAuthor", this.editingPlayer.getName());
            final int i2 = this.fontRendererObj.getStringWidth(s3);
            this.fontRendererObj.drawString(TextFormatting.DARK_GRAY + s3, (float)(i + 36 + (116 - i2) / 2), 60.0f, 0);
            ...
            this.fontRendererObj.drawString(s5, (float)(i - j2 + 192 - 44), 18.0f, 0);
            if (this.cachedComponents == null) {
                ...
                for (int k2 = Math.min(128 / this.fontRendererObj.FONT_HEIGHT, this.cachedComponents.size()), l2 = 0; l2 < k2; ++l2) {
                    ...
                    this.fontRendererObj.drawString(itextcomponent2.getUnformattedText(), (float)(i + 36), (float)(34 + l2 * this.fontRendererObj.FONT_HEIGHT), 0);
                }
