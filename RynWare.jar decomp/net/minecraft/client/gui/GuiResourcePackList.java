...
public abstract class GuiResourcePackList extends GuiListExtended
{
    ...
    protected void drawListHeader(final int insideLeft, final int insideTop, final Tessellator tessellatorIn) {
        ...
        this.mc.fontRendererObj.drawString(s, (float)(insideLeft + this.width / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2), (float)Math.min(this.top + 3, insideTop), 16777215);
    }
