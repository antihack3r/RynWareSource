...
public class GuiListWorldSelectionEntry implements GuiListExtended.IGuiListEntry
{
    ...
    public void func_192634_a(final int p_192634_1_, final int p_192634_2_, final int p_192634_3_, final int p_192634_4_, final int p_192634_5_, final int p_192634_6_, final int p_192634_7_, final boolean p_192634_8_, final float p_192634_9_) {
        ...
        this.client.fontRendererObj.drawString(s, (float)(p_192634_2_ + 32 + 3), (float)(p_192634_3_ + 1), 16777215);
        this.client.fontRendererObj.drawString(s2, (float)(p_192634_2_ + 32 + 3), (float)(p_192634_3_ + this.client.fontRendererObj.FONT_HEIGHT + 3), 8421504);
        this.client.fontRendererObj.drawString(s3, (float)(p_192634_2_ + 32 + 3), (float)(p_192634_3_ + this.client.fontRendererObj.FONT_HEIGHT + this.client.fontRendererObj.FONT_HEIGHT + 3), 8421504);
