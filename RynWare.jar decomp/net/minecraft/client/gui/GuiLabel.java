...
public class GuiLabel extends Gui
{
    ...
    public void drawLabel(final Minecraft mc, final float mouseX, final float mouseY) {
        if (this.visible) {
    ...
    protected void drawLabelBackground(final Minecraft mcIn, final float p_146160_2_, final float p_146160_3_) {
