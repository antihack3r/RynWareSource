...
public class ServerListEntryLanDetected implements GuiListExtended.IGuiListEntry
{
    ...
    public void func_192634_a(final int p_192634_1_, final int p_192634_2_, final int p_192634_3_, final int p_192634_4_, final int p_192634_5_, final int p_192634_6_, final int p_192634_7_, final boolean p_192634_8_, final float p_192634_9_) {
        this.mc.fontRendererObj.drawString(I18n.format("lanServer.title", new Object[0]), (float)(p_192634_2_ + 32 + 3), (float)(p_192634_3_ + 1), 16777215);
        this.mc.fontRendererObj.drawString(this.serverData.getServerMotd(), (float)(p_192634_2_ + 32 + 3), (float)(p_192634_3_ + 12), 8421504);
        if (this.mc.gameSettings.hideServerAddress) {
            this.mc.fontRendererObj.drawString(I18n.format("selectServer.hiddenAddress", new Object[0]), (float)(p_192634_2_ + 32 + 3), (float)(p_192634_3_ + 12 + 11), 3158064);
        }
        else {
            this.mc.fontRendererObj.drawString(this.serverData.getServerIpPort(), (float)(p_192634_2_ + 32 + 3), (float)(p_192634_3_ + 12 + 11), 3158064);
        }
    }
