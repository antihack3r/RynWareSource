...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    public void drawBlurredStringWithShadow(final String text, final double x, final double y, final int blurRadius, final Color blurColor, final int color) {
        ...
        RenderUtils.drawBlurredShadow((float)(int)x, (float)(int)y, (float)this.getStringWidth(text), (float)this.FONT_HEIGHT, blurRadius, blurColor);
    ...
    public void drawCenteredBlurredString(final String text, final double x, final double y, final int blurRadius, final Color blurColor, final int color) {
        GlStateManager.resetColor();
        RenderUtils.drawBlurredShadow((float)(int)((int)x - this.getStringWidth(text) / 2.0f), (float)(int)y, (float)this.getStringWidth(text), (float)this.FONT_HEIGHT, blurRadius, blurColor);
    ...
    public void drawStringWithOutline(final String text, final float x, final float y, final int color) {
    ...
    public int drawString(final String text, final double x, final double y, final int color, final boolean dropShadow) {
        this.enableAlpha();
        if (this.blend) {
    ...
    private int renderString(String text, final float x, final float y, int color, final boolean dropShadow) {
        ...
        this.posX = x;
        this.posY = y;
        if (Main.instance.featureManager.getFeature(NameProtect.class).isEnabled() && NameProtect.myName.getBoolValue()) {
