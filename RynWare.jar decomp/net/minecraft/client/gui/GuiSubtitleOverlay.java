    ...
    public void renderSubtitles(final ScaledResolution resolution) {
        ...
        if (this.enabled && !this.subtitles.isEmpty()) {
            ...
            for (final Subtitle guisubtitleoverlay$subtitle2 : this.subtitles) {
                ...
                if (!flag) {
                    if (d0 > 0.0) {
                        this.client.fontRendererObj.drawString(">", (float)(l - this.client.fontRendererObj.getStringWidth(">")), (float)(-j2), i3 - 16777216);
                    }
                    else if (d0 < 0.0) {
                        this.client.fontRendererObj.drawString("<", (float)(-l), (float)(-j2), i3 - 16777216);
                    }
                }
                this.client.fontRendererObj.drawString(s, (float)(-k2 / 2), (float)(-j2), i3 - 16777216);
