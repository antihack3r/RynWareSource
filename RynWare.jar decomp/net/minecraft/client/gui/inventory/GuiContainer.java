...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        for (int i2 = 0; i2 < this.inventorySlots.inventorySlots.size(); ++i2) {
            ...
            if (this.isMouseOverSlot(slot, mouseX, mouseY)) {
                if (slot.canBeHovered()) {
                    if (Main.instance.featureManager.getFeature(ItemScroller.class).isEnabled() && Mouse.isButtonDown(0) && Keyboard.isKeyDown(this.mc.gameSettings.keyBindSneak.getKeyCode()) && this.mc.currentScreen != null && this.timerHelper.hasReached(ItemScroller.scrollerDelay.getNumberValue())) {
        ...
        if (!itemstack.func_190926_b()) {
            ...
            if (!this.draggedStack.func_190926_b() && this.isRightMouseClick) {
                ...
                itemstack.func_190920_e(MathHelper.ceil(itemstack.getCount() / 2.0f));
            }
    ...
    private void drawSlot(final Slot slotIn) {
        ...
        final String s2;
        if (itemstack.func_190926_b() && slotIn.canBeHovered() && (s2 = slotIn.getSlotTexture()) != null) {
        ...
        if (!itemstack.func_190926_b() && this.dragSplitting) {
            if (this.dragSplittingLimit == 2) {
                ...
                for (final Slot slot : this.dragSplittingSlots) {
                    ...
                    final int i = itemstack3.func_190926_b() ? 0 : itemstack3.getCount();
        ...
        if (this.doubleClick && slot != null && state == 0 && this.inventorySlots.canMergeSlot(ItemStack.field_190927_a, slot)) {
            if (isShiftKeyDown()) {
                if (!this.shiftClickedSlot.func_190926_b()) {
                    for (final Slot slot2 : this.inventorySlots.inventorySlots) {
                        if (slot2 != null && slot2.canTakeStack(this.mc.player) && slot2.getHasStack() && slot2.inventory == slot.inventory) {
                            if (!Container.canAddItemToSlot(slot2, this.shiftClickedSlot, true)) {
                                continue;
                            }
            ...
            if (this.clickedSlot != null && this.mc.gameSettings.touchscreen) {
                ...
                if (state == this.mc.gameSettings.keyBindPickBlock.getKeyCode() + 100) {
                    ...
                    final boolean bl;
                    final boolean flag3 = bl = (k != -999 && (Keyboard.isKeyDown(42) || Keyboard.isKeyDown(54)));
                    if (flag3) {
                        this.shiftClickedSlot = ((slot != null && slot.getHasStack()) ? slot.getStack().copy() : ItemStack.field_190927_a);
                    }
    ...
    public void handleMouseClick(final Slot slotIn, int slotId, final int mouseButton, final ClickType type) {
        if (slotIn != null) {
