...
public class TutorialToast implements IToast
{
    ...
    public Visibility func_193653_a(final GuiToast p_193653_1_, final long p_193653_2_) {
        ...
        if (this.field_193673_e == null) {
            p_193653_1_.func_192989_b().fontRendererObj.drawString(this.field_193672_d, 30.0f, 12.0f, -11534256);
        }
        else {
            p_193653_1_.func_192989_b().fontRendererObj.drawString(this.field_193672_d, 30.0f, 7.0f, -11534256);
            p_193653_1_.func_192989_b().fontRendererObj.drawString(this.field_193673_e, 30.0f, 18.0f, -16777216);
        }
    ...
    public enum Icons
    {
        ...
        private Icons(final int p_i47576_3_, final int p_i47576_4_) {
