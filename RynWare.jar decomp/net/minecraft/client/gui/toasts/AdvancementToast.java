...
public class AdvancementToast implements IToast
{
    ...
    public Visibility func_193653_a(final GuiToast p_193653_1_, final long p_193653_2_) {
        ...
        if (displayinfo != null) {
            ...
            if (list.size() == 1) {
                p_193653_1_.func_192989_b().fontRendererObj.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a(), new Object[0]), 30.0f, 7.0f, i | 0xFF000000);
                p_193653_1_.func_192989_b().fontRendererObj.drawString(displayinfo.func_192297_a().getFormattedText(), 30.0f, 18.0f, -1);
            }
            else {
                final int j = 1500;
                ...
                if (p_193653_2_ < 1500L) {
                    ...
                    p_193653_1_.func_192989_b().fontRendererObj.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a(), new Object[0]), 30.0f, 11.0f, i | k);
                }
                else {
                    ...
                    for (final String s : list) {
                        p_193653_1_.func_192989_b().fontRendererObj.drawString(s, 30.0f, (float)l, 0xFFFFFF | i2);
