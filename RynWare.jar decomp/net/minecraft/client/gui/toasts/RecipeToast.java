...
public class RecipeToast implements IToast
{
    ...
    public Visibility func_193653_a(final GuiToast p_193653_1_, final long p_193653_2_) {
        ...
        p_193653_1_.func_192989_b().fontRendererObj.drawString(I18n.format("recipe.toast.title", new Object[0]), 30.0f, 7.0f, -11534256);
        p_193653_1_.func_192989_b().fontRendererObj.drawString(I18n.format("recipe.toast.description", new Object[0]), 30.0f, 18.0f, -16777216);
