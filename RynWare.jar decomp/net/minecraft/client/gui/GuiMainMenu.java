...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiMainMenuButton(this.mc.stylesIcons, 5, this.width / 2 - 50, this.height / 2 + 118, 30, 15, "E", true));
        this.buttonList.add(new GuiMainMenuButton(this.mc.stylesIcons, 4, this.width / 2 - 15, this.height / 2 + 118, 30, 15, "I", true));
        this.buttonList.add(new GuiMainMenuButton(this.mc.ikonki2, 6, this.width / 2 + 20, this.height / 2 + 118, 30, 15, "E", true));
    }
