...
public class GuiSnooper extends GuiScreen
{
    ...
    class List extends GuiSlot
    {
        ...
        protected void func_192637_a(final int p_192637_1_, final int p_192637_2_, final int p_192637_3_, final int p_192637_4_, final int p_192637_5_, final int p_192637_6_, final float p_192637_7_) {
            GuiSnooper.this.fontRendererObj.drawString(GuiSnooper.this.keys.get(p_192637_1_), 10.0f, (float)p_192637_3_, 16777215);
            GuiSnooper.this.fontRendererObj.drawString(GuiSnooper.this.values.get(p_192637_1_), 230.0f, (float)p_192637_3_, 16777215);
        }
