...
import org.rynware.client.event.events.impl.player.RespawnEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleJoinGame(final SPacketJoinGame packetIn) {
        ...
        final RespawnEvent event = new RespawnEvent();
    ...
    public void handleEntityVelocity(final SPacketEntityVelocity packetIn) {
        ...
        if (entity != null) {
            if (Velocity.velocityMode.currentMode.equals("Matrix") && Main.instance.featureManager.getFeature(Velocity.class).isEnabled()) {
                if (packetIn.getEntityID() == Minecraft.getMinecraft().player.getEntityId()) {
                    entity.setVelocity(0.0, packetIn.getMotionY() / 8000.0, packetIn.getMotionZ() / 8000.0 / 2.5);
                }
            }
            else {
    ...
    public void onDisconnect(final ITextComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new NewMainMenu()), "disconnect.lost", reason));
        }
    }
    ...
    public void func_194307_a(final SPacketPlaceGhostRecipe p_194307_1_) {
        ...
        if (container.windowId == p_194307_1_.func_194313_b() && container.getCanCraft(this.gameController.player) && this.gameController.currentScreen instanceof IRecipeShownListener) {
            final GuiRecipeBook guirecipebook = ((IRecipeShownListener)this.gameController.currentScreen).func_194310_f();
