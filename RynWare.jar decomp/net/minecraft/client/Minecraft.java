...
import org.rynware.client.ui.font.FontUtil;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    public MCFontRenderer latoSmall;
    public org.rynware.client.font.MCFontRenderer latoFontRender;
    ...
    public MCFontRenderer neverlose500_40;
    ...
    public MCFontRenderer neverlose900_60;
    public MCFontRenderer notification;
    public MCFontRenderer rubik_35;
    public MCFontRenderer rubik_30;
    public MCFontRenderer rubik_25;
    ...
    public MCFontRenderer tenacity_16;
    public MCFontRenderer tenacitybold_16;
    public MCFontRenderer apple_16;
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.latoBig = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/lato.ttf"), 30.0f, 0), true, true);
        this.latoSmall = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/lato.ttf"), 20.0f, 0), true, true);
        ...
        this.neverlose500_40 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/neverlose500.ttf"), 40.0f, 0), true, true);
        ...
        this.neverlose900_30 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/neverlose900.ttf"), 30.0f, 0), true, true);
        this.neverlose900_60 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/neverlose900.ttf"), 60.0f, 0), true, true);
        this.rubik_35 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/rubik.ttf"), 35.0f, 0), true, true);
        this.rubik_30 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/rubik.ttf"), 30.0f, 0), true, true);
        this.rubik_25 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/rubik.ttf"), 25.0f, 0), true, true);
        ...
        this.ikonki2 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/ikonki2.ttf"), 30.0f, 0), true, true);
        ...
        this.tenacity_16 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/tenacity.ttf"), 16.0f, 0), true, true);
        this.tenacitybold_16 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/tenacitybold.ttf"), 16.0f, 0), true, true);
        this.apple_16 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/apple.ttf"), 16.0f, 0), true, true);
        ...
        Main.instance.init();
        Main.instance.configManager.loadConfig("default");
        try {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Main.instance.name + " " + Main.instance.type + " " + Main.instance.version);
        try {
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("rynware/icon64.png"));
                inputstream2 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("rynware/icon32.png"));
    ...
    public void displayGuiScreen(@Nullable GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn instanceof NewMainMenu || guiScreenIn instanceof GuiMultiplayer) {
            this.gameSettings.showDebugInfo = false;
            this.ingameGUI.getChatGUI().clearChatMessages(!Main.instance.featureManager.getFeature(ChatHistory.class).isEnabled());
        }
    ...
    private void runTickKeyboard() throws IOException {
        while (Keyboard.next()) {
            ...
            if (flag) {
                ...
                boolean flag2 = false;
                if (this.currentScreen == null) {
                    final EventInputKey event = new EventInputKey(i);
    ...
    private void runTickMouse() throws IOException {
        while (Mouse.next()) {
            ...
            if (Mouse.getEventButtonState()) {
                final EventMouse eventMouse = new EventMouse(i);
