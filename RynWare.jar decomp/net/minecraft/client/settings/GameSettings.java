        ...
        if (settingOption.getEnumFloat()) {
            ...
            if (settingOption == Options.GRAPHICS) {
                ...
                if (settingOption == Options.NARRATOR) {
                    return NarratorChatListener.field_193643_a.func_193640_a() ? (s2 + getTranslation(GameSettings.field_193632_b, this.field_192571_R)) : (s2 + I18n.format("options.narrator.notavailable", new Object[0]));
                }
                return s2;
            }
        }
