...
public class BlockRendererDispatcher implements IResourceManagerReloadListener
{
    ...
    public boolean renderBlock(IBlockState state, final BlockPos pos, final IBlockAccess blockAccess, final BufferBuilder worldRendererIn) {
        final EventRenderBlock event = new EventRenderBlock(state, pos, blockAccess, worldRendererIn);
