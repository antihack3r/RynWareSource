...
public class ItemRenderer
{
    ...
    private void renderArmFirstPerson(final float p_187456_1_, final float p_187456_2_, final EnumHandSide p_187456_3_) {
        final EventTransformSideFirstPerson event = new EventTransformSideFirstPerson(p_187456_3_);
    ...
    private void transformEatFirstPerson(final float p_187454_1_, final EnumHandSide p_187454_2_, final ItemStack p_187454_3_) {
        final EventTransformSideFirstPerson event = new EventTransformSideFirstPerson(p_187454_2_);
        EventManager.call(event);
        ...
        final int n;
        final int i = n = ((p_187454_2_ == EnumHandSide.RIGHT) ? 1 : -1);
        if (f2 < 0.8f) {
            final float f4 = MathHelper.abs(MathHelper.cos(f / 4.0f * 3.1415927f) * 0.1f);
            GlStateManager.translate(0.0f, f4, 0.0f);
        }
        GlStateManager.translate(f3 * 0.6f * i, f3 * -0.5f, f3 * 0.0f);
        if (Main.instance.featureManager.getFeature(ViewModel.class).isEnabled()) {
            GlStateManager.rotate(i * f3 * 20.0f, 0.0f, 1.0f, 0.0f);
        }
        else {
    ...
    private void transformFirstPerson(final EnumHandSide p_187453_1_, final float p_187453_2_) {
        ...
        if (Main.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && SwingAnimations.item360.getBoolValue()) {
    ...
    private void transformSideFirstPerson(final EnumHandSide p_187459_1_, final float p_187459_2_) {
        final EventTransformSideFirstPerson event = new EventTransformSideFirstPerson(p_187459_1_);
        EventManager.call(event);
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
            ...
            if (p_187457_6_.func_190926_b()) {
                ...
                if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
                    ...
                    if ((Main.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && !SwingAnimations.auraOnly.getBoolValue()) || (Main.instance.featureManager.getFeature(KillAura.class).isEnabled() && KillAura.target != null)) {
                        if ((Main.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && !SwingAnimations.auraOnly.getBoolValue()) || (Main.instance.featureManager.getFeature(KillAura.class).isEnabled() && KillAura.target != null)) {
                            if (enumhandside != (this.mc.gameSettings.mainHand.equals(EnumHandSide.LEFT) ? EnumHandSide.RIGHT : EnumHandSide.LEFT)) {
                                if (mode.equalsIgnoreCase("Default")) {
                                ...
                                else if (mode.equalsIgnoreCase("Main")) {
                                    this.transformFirstPersonItem(0.0f, 0.0f);
                                    this.translate4();
                                    final float var3 = MathHelper.sin(swingprogress * swingprogress * 3.1415927f);
                                    final float var4 = MathHelper.sin(MathHelper.sqrt(swingprogress) * 3.1415927f);
                                ...
                                else if (mode.equalsIgnoreCase("Drochka")) {
                                    this.transformFirstPersonItem(0.0f, 0.0f);
                                    ...
                                    GlStateManager.rotate(this.mc.player.isSwingInProgress ? (-alpha / SwingAnimations.swingSpeed.getNumberValue()) : 1.0f, 1.0f, -0.0f, 1.0f);
                                    GlStateManager.translate(0.0, 0.0, 0.5);
                                }
                            }
                            else {
    ...
    public void renderOverlays(final float partialTicks) {
        ...
        if (!this.mc.player.isSpectator()) {
            ...
            if (!Main.instance.featureManager.getFeature(NoOverlay.class).isEnabled() && !NoOverlay.noFire.getBoolValue() && this.mc.player.isBurning() && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, this.mc.player, partialTicks)) {
