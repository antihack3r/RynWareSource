...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void renderItemOverlays(final MCFontRenderer fr, final ItemStack stack, final int xPosition, final int yPosition) {
    ...
    public void renderItemOverlayIntoGUI(final MCFontRenderer fr, final ItemStack stack, final int xPosition, final int yPosition, @Nullable final String text) {
        if (!stack.func_190926_b()) {
