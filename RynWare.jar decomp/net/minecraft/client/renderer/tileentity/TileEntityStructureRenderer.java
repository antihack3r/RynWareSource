...
{
    @Override
    public void func_192841_a(final TileEntityStructure p_192841_1_, final double p_192841_2_, final double p_192841_4_, final double p_192841_6_, final float p_192841_8_, final int p_192841_9_, final float p_192841_10_) {
        if (Minecraft.getMinecraft().player.canUseCommandBlock() || Minecraft.getMinecraft().player.isSpectator()) {
            ...
            final BlockPos blockpos = p_192841_1_.getPosition();
            final BlockPos blockpos2 = p_192841_1_.getStructureSize();
            if (blockpos2.getX() >= 1 && blockpos2.getY() >= 1 && blockpos2.getZ() >= 1 && (p_192841_1_.getMode() == TileEntityStructure.Mode.SAVE || p_192841_1_.getMode() == TileEntityStructure.Mode.LOAD)) {
                final double d0 = 0.01;
                final double d2 = blockpos.getX();
                final double d3 = blockpos.getZ();
                final double d4 = p_192841_4_ + blockpos.getY() - 0.01;
                ...
                switch (p_192841_1_.getRotation()) {
                    case CLOCKWISE_90: {
                        d8 = p_192841_2_ + ((d7 < 0.0) ? (d2 - 0.01) : (d2 + 1.0 + 0.01));
                        d9 = p_192841_6_ + ((d6 < 0.0) ? (d3 + 1.0 + 0.01) : (d3 - 0.01));
                        d10 = d8 - d7;
                        d11 = d9 + d6;
                        break;
                    }
                    case CLOCKWISE_180: {
                        d8 = p_192841_2_ + ((d6 < 0.0) ? (d2 - 0.01) : (d2 + 1.0 + 0.01));
                        d9 = p_192841_6_ + ((d7 < 0.0) ? (d3 - 0.01) : (d3 + 1.0 + 0.01));
                        d10 = d8 - d6;
                        d11 = d9 - d7;
                        break;
                    }
                    case COUNTERCLOCKWISE_90: {
                        d8 = p_192841_2_ + ((d7 < 0.0) ? (d2 + 1.0 + 0.01) : (d2 - 0.01));
                        d9 = p_192841_6_ + ((d6 < 0.0) ? (d3 - 0.01) : (d3 + 1.0 + 0.01));
                        d10 = d8 + d7;
                        d11 = d9 - d6;
                        break;
                    }
                    default: {
                        d8 = p_192841_2_ + ((d6 < 0.0) ? (d2 + 1.0 + 0.01) : (d2 - 0.01));
                        d9 = p_192841_6_ + ((d7 < 0.0) ? (d3 + 1.0 + 0.01) : (d3 - 0.01));
                        d10 = d8 + d6;
                        d11 = d9 + d7;
                        break;
                    }
