...
public abstract class World implements IBlockAccess
{
    ...
    private boolean func_191504_a(@Nullable final Entity p_191504_1_, final AxisAlignedBB p_191504_2_, final boolean p_191504_3_, @Nullable final List<AxisAlignedBB> p_191504_4_) {
        ...
        if (i3 > l2) {
            ...
            while (j2 < k2) {
                ...
                if (j5 == i5) {
                    ...
                    final BlockPos.PooledMutableBlockPos blockpos$pooledmutableblockpos = BlockPos.PooledMutableBlockPos.retain();
                    for (final EnumFacing enumfacing : EnumFacing.values()) {
                        final int j6 = j4 + enumfacing.getFrontOffsetX();
                        final int k6 = k4 + enumfacing.getFrontOffsetY();
                        final int l6 = l4 + enumfacing.getFrontOffsetZ();
    ...
    public boolean func_190527_a(final Block p_190527_1_, final BlockPos p_190527_2_, final boolean p_190527_3_, final EnumFacing p_190527_4_, @Nullable final Entity p_190527_5_) {
        final IBlockState iblockstate1 = this.getBlockState(p_190527_2_);
        final AxisAlignedBB axisalignedbb = p_190527_3_ ? null : p_190527_1_.getDefaultState().getCollisionBoundingBox(this, p_190527_2_);
        return (axisalignedbb == Block.NULL_AABB || this.checkNoEntityCollision(axisalignedbb.offset(p_190527_2_), p_190527_5_)) && ((iblockstate1.getMaterial() == Material.CIRCUITS && p_190527_1_ == Blocks.ANVIL) || (iblockstate1.getMaterial().isReplaceable() && p_190527_1_.canPlaceBlockOnSide(this, p_190527_2_, p_190527_4_)));
    }
    ...
    public EntityPlayer getNearestAttackablePlayer(final double posX, final double posY, final double posZ, final double maxXZDistance, final double maxYDistance, @Nullable final Function<EntityPlayer, Double> playerToDouble, @Nullable final Predicate<EntityPlayer> p_184150_12_) {
        ...
        for (int j2 = 0; j2 < this.playerEntities.size(); ++j2) {
            final EntityPlayer entityplayer2 = this.playerEntities.get(j2);
            if (!entityplayer2.capabilities.disableDamage && entityplayer2.isEntityAlive() && !entityplayer2.isSpectator() && (p_184150_12_ == null || p_184150_12_.apply((Object)entityplayer2))) {
    ...
    public Random setRandomSeed(final int p_72843_1_, final int p_72843_2_, final int p_72843_3_) {
        final long j2 = p_72843_1_ * 341873128712L + p_72843_2_ * 132897987541L + this.getWorldInfo().getSeed() + p_72843_3_;
