...
public class RandomPositionGenerator
{
    ...
    @Nullable
    public static Vec3d func_191377_b(final EntityCreature p_191377_0_, final int p_191377_1_, final int p_191377_2_) {
    ...
    @Nullable
    private static Vec3d func_191379_a(final EntityCreature p_191379_0_, final int p_191379_1_, final int p_191379_2_, @Nullable final Vec3d p_191379_3_, final boolean p_191379_4_) {
        ...
        for (int l = 0; l < 10; ++l) {
            ...
            if (p_191379_3_ == null || m * p_191379_3_.xCoord + j2 * p_191379_3_.zCoord >= 0.0) {
                ...
                if ((!flag || p_191379_0_.isWithinHomeDistanceFromPosition(blockpos2)) && pathnavigate.canEntityStandOnPos(blockpos2)) {
                    if (!p_191379_4_) {
                        blockpos2 = func_191378_a(blockpos2, p_191379_0_);
                        if (func_191380_b(blockpos2, p_191379_0_)) {
                            continue;
                        }
                    }
    ...
    private static BlockPos func_191378_a(final BlockPos p_191378_0_, final EntityCreature p_191378_1_) {
    ...
    private static boolean func_191380_b(final BlockPos p_191380_0_, final EntityCreature p_191380_1_) {
