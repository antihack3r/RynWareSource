...
public abstract class EntityLivingBase extends Entity
{
    ...
    private long desyncTicks;
    public long ticksBlock;
    ...
    private boolean func_190628_d(final DamageSource p_190628_1_) {
        ...
        for (final EnumHand enumhand : EnumHand.values()) {
            ...
            if (itemstack2.getItem() == Items.Totem) {
    ...
    private int getArmSwingAnimationEnd() {
        if (Main.instance.featureManager.getFeature(SwingAnimations.class).isEnabled()) {
            final int speed = (int)SwingAnimations.swingSpeed.getNumberValue();
    ...
    public long getDesyncTick() {
        if (this.getActiveItemStack().getItem() instanceof ItemShield) {
            if (!this.isStarted) {
                this.desyncTicks = System.currentTimeMillis();
            }
            this.isStarted = true;
        }
        else {
        ...
        return System.currentTimeMillis() - this.desyncTicks;
    }
    ...
    public void onUpdate() {
        ...
        this.ticksBlock = this.getDesyncTick();
        if (!this.world.isRemote) {
    ...
    public boolean canBePushed() {
        return (!Main.instance.featureManager.getFeature(NoPush.class).isEnabled() || !NoPush.players.getBoolValue() || !(this instanceof EntityPlayerSP)) && this.isEntityAlive() && !this.isOnLadder();
    }
