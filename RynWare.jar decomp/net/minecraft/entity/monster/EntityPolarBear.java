...
public class EntityPolarBear extends EntityAnimal
{
    ...
    class AIAttackPlayer extends EntityAINearestAttackableTarget<EntityPlayer>
    {
        ...
        public boolean shouldExecute() {
            ...
            if (super.shouldExecute()) {
                for (final EntityPolarBear entitypolarbear : EntityPolarBear.this.world.getEntitiesWithinAABB((Class<? extends EntityPolarBear>)EntityPolarBear.class, EntityPolarBear.this.getEntityBoundingBox().expand(8.0, 4.0, 8.0))) {
    ...
    class AIMeleeAttack extends EntityAIAttackMelee
    {
        ...
        @Override
        protected void checkAndPerformAttack(final EntityLivingBase p_190102_1_, final double p_190102_2_) {
            final double d0 = this.getAttackReachSqr(p_190102_1_);
