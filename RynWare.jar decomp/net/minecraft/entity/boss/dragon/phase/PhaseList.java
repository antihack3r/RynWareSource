...
public class PhaseList<T extends IPhase>
{
    ...
    public static PhaseList<?> getById(final int p_188738_0_) {
        return (p_188738_0_ >= 0 && p_188738_0_ < PhaseList.phases.length) ? PhaseList.phases[p_188738_0_] : PhaseList.HOLDING_PATTERN;
    }
    ...
    static {
        PhaseList.phases = new PhaseList[0];
