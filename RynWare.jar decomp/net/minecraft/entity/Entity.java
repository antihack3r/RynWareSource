...
public abstract class Entity implements ICommandSender
{
    ...
    public void func_191958_b(float p_191958_1_, float p_191958_2_, float p_191958_3_, final float p_191958_4_) {
        ...
        if (f >= 1.0E-4f) {
            ...
            final float f2 = MathHelper.sin(yaw * 0.017453292f);
            final float f3 = MathHelper.cos(yaw * 0.017453292f);
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        if (Main.instance.featureManager.getFeature(NoPush.class).isEnabled() && NoPush.blocks.getBoolValue()) {
            return false;
        }
    ...
    public float getCollisionBorderSize() {
        ...
        if (Main.instance.featureManager.getFeature(HitBox.class).isEnabled()) {
