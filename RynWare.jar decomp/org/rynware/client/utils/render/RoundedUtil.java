...
public class RoundedUtil
{
    ...
    static {
        RoundedUtil.roundedShader = new ShaderUtil("rynware/shaders/roundedrect.frag");
        RoundedUtil.roundedOutlineShader = new ShaderUtil("rynware/shaders/roundrectoutline.frag");
        roundedTexturedShader = new ShaderUtil("rynware/shaders/roundrecttextured.frag");
